...
export default function FavoritesEmptyState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg bg-white dark:bg-gray-900 max-w-md mx-auto">
      ...
      <Link
        href="/discovery"
        className="inline-flex items-center justify-center px-6 py-3 bg-primary-light  text-black hover:text-white font-medium rounded-full transition-colors hover:bg-primary-color focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-offset-2"
      >
        {t('explore_store')}
      </Link>
    </div>
