      ...
      <View style={[styles.headerSkeleton, { backgroundColor: currentTheme.cardBackground }]}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={[styles.reviewButton, { backgroundColor: currentTheme.newButtonBackground || '#FFE2D0' }]}>
              <SkeletonPlaceholder currentTheme={currentTheme} style={{ width: scale(80), height: scale(16), borderRadius: scale(3) }} />
            </View>
          </View>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={[styles.statusButton, { backgroundColor: currentTheme.newButtonBackground || '#FFE2D0' }]}>
